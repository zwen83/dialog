...
iniFilename = r'C:\Users\zwen.073111-PC\dialog\Asia platforms\Asia HUB.ini'
__author__ = 'isim'
__version__ = 4.0
...
def addPoint(pointList, measurement, value, terminal, now, platform, additionalFields=None):
    ...
    pointList.append({'fields': fields, 'measurement': measurement, 'tags': {'satnet': terminal['satnet'], 'platform': platform, 'modem_name': terminal['id']['name'], 'modem_id': terminal['id']['systemId'], 'vno_name': terminal['id']['domainName'], 'vno_id': terminal['id']['domainId']}, 'time': now})
    print(pointList)
#--------------------------------------------------------------------------#
