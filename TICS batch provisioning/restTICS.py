...
class REST:
    ...
    def __init__(self, ip, username = 'hno', password = 'D!@10g', contenttype = '', timeout=300, keepcookies=True):
        ...
        self.cookies = None
        logger.debug('An instance of REST with ip %s created' % ip)
...
#all magic happens here
    def _request(self, function, resource, payload, service, interface='/tics/rest/', params=None, cookies=None, timeout=0):
        ...
        try:
            self.reply = getattr(requests, function)(request_url, auth=self._auth, headers=self._headers, json=payload, params=params, cookies=(cookies if cookies else self.cookies), timeout=(timeout if timeout else self._timeout))
...
#next four functions provide GET, POST, PUT and DELETE
    def GET(self, resource, service = '', interface = '/tics/rest/', params='', cookies=None, timeout=0):
        '''GET(resource)
        ...
        '''
        return self._request('get', resource, '', service, interface, params, cookies, timeout)

    def POST(self, resource, payload = '', service = '', interface = '/tics/rest/', cookies=None, timeout=0):
        ...
        also "reply.text" contains raw output of the latest call:
        '''
        return self._request('post', resource, payload, service, interface, cookies, timeout)

    def PUT(self, resource, payload, service = '', interface = '/tics/rest/', cookies=None, timeout=0):
        ...
        also "reply.text" contains raw output of the latest call:
        '''
        return self._request('put', resource, payload, service, interface, cookies, timeout)

    def DELETE(self, resource, payload = '', service = '', interface = '/tics/rest/', cookies=None, timeout=0):
        ...
        also "reply.text" contains raw output of the latest call:
        '''
        return self._request('delete', resource, payload, service, interface, cookies, timeout)
