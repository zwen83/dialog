...
#all magic happens here
    def _request(self, function, resource, payload, service, interface='/rest/', params=None, cookies=None, timeout=0):
...
#next four functions provide GET, POST, PUT and DELETE
    def GET(self, resource, service = '', interface = '/rest/', params='', cookies=None, timeout=0):
        '''GET(resource)
    ...
    def POST(self, resource, payload = '', service = '', interface = '/rest/', cookies=None, timeout=0):
    ...
    def PUT(self, resource, payload, service = '', interface = '/rest/', cookies=None, timeout=0):
    ...
    def DELETE(self, resource, payload = '', service = '', interface = '/rest/', cookies=None, timeout=0):
